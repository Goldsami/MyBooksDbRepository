        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BooksLists_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<int>(type: "int", nullable: false),
                    BooksListId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_BooksLists_BooksListId",
                        column: x => x.BooksListId,
                        principalTable: "BooksLists",
                        principalColumn: "BooksListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_BooksListId",
                table: "Books",
                column: "BooksListId");

            migrationBuilder.CreateIndex(
                name: "IX_BooksLists_UserId",
                table: "BooksLists",
                column: "UserId");
